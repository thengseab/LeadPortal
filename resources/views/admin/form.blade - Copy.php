        ...
        <section>  
                ...
                <div class="card-body admin-page">                    
                    <form id="booking_room_form" action="{{!empty($list_booking->id)? route('update-booking',['id'=>$list_booking->id]):route('lists-booking.save')}}" method="post">
                        {!! csrf_field() !!}
                        <input type="text" name="booking_id" class="form-control" id="booking_id" value="{{$list_booking->id}}" style="display:block;">
                        <div class="row">                          
                            <div class="col-md-4">
                        ...
                        <div class="form-group text-right">
                            <input class="btn-save" type="submit" value="{{!empty($list_booking->id)? 'Update':'Save'}}">
                        </div>
                    </form>
                </div>
